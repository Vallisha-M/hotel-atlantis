...
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/> 
  ...
  <div className="banner"><img src={spices} width="100%" height="800px" /><div className="overlayText" align="center">
      &nbsp;&nbsp;&nbsp;
      <br /><br />
      <div className="justText" align="center">Indian Palace</div>	
    </div></div>
  <div>
    <button className="cart_button" id="cartbtn" onClick={() => pop('cartdiv')} ><img src={cart} height="30px" width="30px" /></button>
  </div>
  <h1>SOUPS</h1> 
  ...
  <div className="cardlist">
    ...
    <div className="card">
      <img className="item_image" src={mt} alt="loading" style={{"width":"100%"}} />
    ...
    <div className="card">
      <img className="item_image" src={vm} alt="loading" style={{"width":"100%"}} />
    ...
    <div className="card">
      <img className="item_image" src={bm} alt="loading" style={{"width":"100%"}} />
    ...
    <div className="card">
      <img className="item_image" src={sr} alt="loading" style={{"width":"100%"}} />
    ...
    <div className="card">
      <img className="item_image" src={cf} alt="loading" style={{"width":"100%"}} />
  ...
  <div className="cardlist">
    ...
    <div className="card">
      <img className="item_image" src="img/dal-fry.jfif" alt="loading" style={{"width":"100%"}} />
    ...
    <div className="card">
      <img className="item_image" src="img/MalaiKoftaCurry-1.jpg" alt="loading" style={{"width":"100%"}} />
    ...
    <div className="card">
      <img className="item_image" src="img/Restaurant-Style-Paneer-Butter-Masala-3.jpg" alt="loading" style={{"width":"100%"}} />
    ...
    <div className="card">
      <img className="item_image" src="img/dumBIRYANI.JPG" alt="loading" style={{"width":"100%"}} />
    ...
    <div className="card">
      <img className="item_image" src="img/Ghee-Rice2-1.jpg" alt="loading" style={{"width":"100%"}} />
    ...
    <div className="card">
      <img className="item_image" src="img/pnrb.jpg" alt="loading" style={{"width":"100%"}} />
    ...
    <div className="card">
      <img className="item_image" src="img/shahi.jpg" alt="loading" style={{"width":"100%"}} />
  ...
  <div className="cardlist">
    <div className="card">
      <img className="item_image" src="img/masala kulcha.jfif" />
...
<div id="cartdiv">
  <section className="container-d content-section">
    ...
    <span className="close_cart" onClick={() => hide('cartdiv')}>×</span>
    ...
    <button id="btn-primary" className="btn-primary" onClick={async() => await finald()} type="button">PRE ORDER</button>
  </section>
</div> </div>
