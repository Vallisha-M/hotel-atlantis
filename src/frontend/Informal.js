        ...
        <form id='form' name='form' onSubmit={handleSubmit}>
          ...
          <div className='question'>
            <label htmlFor='eventType'>
              <h3>2. Which one of these best describes you event :&nbsp;</h3>
            </label>
            <br />
            <select
              name='eventType'
            ...
            >
              ...
              <option value='Birthday - kid'>Birthday - Kid</option>
              <option value='Birthday - Adult'>Birthday - Adult</option>
              <option value='Other Family Event'>Other Family Event</option>
          ...
          <div className='question'>
            <label htmlFor='guests'>
              <h3>
                4. How many guests are expected to arrive?&nbsp;&nbsp;&nbsp;
              </h3>
            </label>
            <br />
            <select
          ...
          <div className='question'>
            <label htmlFor='date'>
              <h3>5. When do you plan to host the event?&nbsp;&nbsp;&nbsp;</h3>
            </label>
            <br />
            <br />
            <input
